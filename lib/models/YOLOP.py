...
from lib.models.common import Conv, SPP, Bottleneck, BottleneckCSP, Focus, Concat, Detect, SharpenConv, C2f, SPPF,RepNCSPELAN4,ADown, SPPELAN
...
if __name__ == "__main__":
    ...
    model_out,dring_area_seg, lane_line_seg = model(input_) ##added sad2
